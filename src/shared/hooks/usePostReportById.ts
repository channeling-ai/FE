...
import { ResponseReportById, ResultReportById } from '../types'
import { useReportStore } from '../store'
import { postReportById } from '../api'
 ...
 */
export function usePostReportById({ onSuccess, onError }: ReportByIdCallbacks) {
